...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def setUp(self):
        self.allcondition = [[], ['input2.txt'], ['/p', 'input2.txt'], ['/p', '/p', 'input2.txt'], ['/p', '/p', '/p', 'input2.txt'], ['input2.txt'], ['/h', 'input2.txt'], ['/v', 'input2.txt'], ['/a', 'input2.txt'], ['/h', '/v', 'input2.txt'], ['/h', '/v', '/a', 'input2.txt']]     # 所有参数情况
